...
import MiBandbluetooth.Bluetooth.Actions.SetDeviceStateAction;
...
import MiBandbluetooth.Utils.BleNamesResolver;
import MiBandbluetooth.Utils.CalendarUtils;
...
public class MiBandSupport extends BluetoothGattCallback {
    ...
    public static BluetoothQueue mQueue;
