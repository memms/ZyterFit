...
import MiBandbluetooth.Bluetooth.Actions.AbstractGattListenerWriteAction;
...
public class BluetoothQueue {
    ...
    public static final BlockingQueue<Transaction> mTransactions = new LinkedBlockingQueue<>();
    private volatile boolean mCrashed;
    public static volatile boolean mAbortTransaction;

    private final Context mContext;
    private CountDownLatch mWaitForActionResultLatch;
    private CountDownLatch mConnectionLatch;
    private BluetoothGattCharacteristic mWaitCharacteristic;
    public static InternalGattCallback internalGattCallback;
